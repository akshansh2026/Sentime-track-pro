...
if "users_db" not in st.session_state: 
    st.session_state.users_db = {"admin@startup.com": {"password": "admin", "name": "Admin User", "phone": "+919876543210"}}
...
# =====================================================================
    ...
    if stock_df.empty and nav not in ["📌 Custom Portfolio", "👤 My Profile"]:
        st.warning(f"⚠️ Could not find data for {ticker}. Please select a valid ticker.")
    else:
